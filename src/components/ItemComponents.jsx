...
const ListItem = ({ img64 }) => {
  ...
  return (
    <div>
      ...
      >
        <div style={{ width: '10em', height: '100%', backgroundColor: 'white', borderRadius: '20px' }}>
          <img 
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <b><p style={{ margin: '0 0 0 0', fontFamily: 'ibm-plex-sans, sans-serif', fontSize: '22px', paddingBottom: '0.5rem' }}>10 Points</p></b>
            <p style={{ margin: '0 0 0 0', fontFamily: 'K2D, sans-serif', fontSize: '18px', paddingBottom: '0.5rem' }}>Not Found</p>
            <p style={{ margin: '0 0 0 0', fontFamily: 'K2D, sans-serif', fontSize: '18px', paddingBottom: '0.5rem' }}>0 Teams Found</p>
          </div>
          <div style={{ width: '0.5em', height: '100%', backgroundColor: 'red', borderRadius: '20px' }} />
        </div>
      </div>
    </div>
  );
